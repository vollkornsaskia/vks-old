...
BLOG_AUTHOR = "Saskia"  # (translatable)
BLOG_TITLE = "Vollkornsaskia"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://vollkornsaskia.de/"
...
INDEX_READ_MORE_LINK = '<p class="more"><a href="{link}"><b>{read_more}…</b></a></p>'
...
# (translatable)
CONTENT_FOOTER = '<a href="/pages/impressum/">Impressum</a>'
